...
/*/{Protheus.doc} APIZR201
Webservice Responsavel por realizar a busca dos dados de Filiais.
@type method 
...
/*/
//=============================================================================================================================
    WSRestFul Filiais Description "Busca os dados de Filiais no sistema"
//=============================================================================================================================
    ...
    WsMethod GET Description "Busca os dados de Filiais no sistema." WsSyntax "/Filiais"
End WSRestFul

/*/{Protheus.doc} GET - Filiais
...
/*/
//=============================================================================================================================
    WsMethod GET WsReceive startindex, count, Empresa, Filial, Filter, pk WsRest Filiais
//=============================================================================================================================
    ...
    oApiExc := APIExeJS():New("oRestZR2","001",RetCodUsr(),"GET",::Empresa,::Filial,{"ZR2"},::pk)
