...
/*/{Protheus.doc} APISC101
Webservice Responsavel por realizar a busca dos dados de Solicitações de Compra.
@type method 
...
/*/
//=============================================================================================================================
    WSRestFul SolCompras Description "Busca os dados de Solicitações de Compra no sistema"
//=============================================================================================================================
    ...
    WsMethod GET Description "Busca os dados de Solicitações de Compra no sistema." WsSyntax "/SolCompras"
End WSRestFul

/*/{Protheus.doc} GET - SolCompras
...
/*/
//=============================================================================================================================
    WsMethod GET WsReceive startindex, count, Empresa, Filial, Filter, pk WsRest SolCompras
//=============================================================================================================================
    ...
    oApiExc := APIExeJS():New("oRestSC1","001",RetCodUsr(),"GET",::Empresa,::Filial,{"SC1"},::pk)
