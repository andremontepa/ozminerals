		...
		If ( cAdt )
			If Len(oRest5) > 0
				...
				If ( Alltrim(cEmpTit) == Alltrim(cEmpAnt) )
					If ( lPassa )
						u_YGeraPA(nValor,ccpf,cuserid,cID,dEmiss,cHIst,cEmail,cEmpTit,cFilTit,cCostCenter,cCredConta,cDebConta,cCCusto,cItemCta,cClasseVlr) // CHAMA A FUNÇÃO QUE GERA PA
					Else 
