...
/*/
//--------------------------------------------------------------------
User Function updOz( cEmpAmb, cFilAmb )
	Local   aSay      := {}
	Local   aButton   := {}
	Local   aMarcadas := {}
	...
	If lOk
		...
		If !Empty( aMarcadas )
			If lAuto .OR. MsgNoYes( "Confirma a atualização dos dicionários ?", cTitulo )
				...
				If lAuto
					If lOk
						MsgInfo( "Atualização realizada.", "updOz" )
					Else
						MsgStop( "Atualização não realizada.", "updOz" )
					EndIf
					dbCloseAll()
				Else
					If lOk
...
//
	...
	3																		, ; //X3_TAMANHO
	0																		, ; //X3_DECIMAL
	'Cont. Impres'															, ; //X3_TITULO
	'Cont. Impres'															, ; //X3_TITSPA
	'Cont. Impres'															, ; //X3_TITENG
	''																		, ; //X3_DESCRIC
	''																		, ; //X3_DESCSPA
	''																		, ; //X3_DESCENG
	'@!'																	, ; //X3_PICTURE
...
// Marca/Desmarca por mascara
	...
	@ 112, 157  Button oButOk   Prompt "Processar"  Size 32, 12 Pixel Action (  RetSelecao( @aRet, aVetor ), IIf( Len( aRet ) > 0, oDlg:End(), MsgStop( "Ao menos um grupo deve ser selecionado", "updOz" ) ) ) ;
...
//
	...
	'01'																	, ; //XB_SEQ
	'01'																	, ; //XB_COLUNA
	'Nr.s.a. + Item S.a. '																, ; //XB_DESCRI
	'Nr.s.a. + Item S.a. '																	, ; //XB_DESCSPA
	'Nr.s.a. + Item S.a. '																	, ; //XB_DESCENG
	''																		, ; //XB_WCONTEM
	''																		} ) //XB_CONTEM
