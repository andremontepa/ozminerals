...
#DEFINE ROTINA_FILE				"OZ06M03.prw"
...
#Define ALIAS_FORM0 			"PAK" 
#Define MODELO					"OZ06M03"
#Define ID_MODEL				"OZ06A03"
#Define TITULO_MODEL			"Cadastro Contabil Argo - Uso Protheus - OZMinerals" + SubStr(VERSAO_ROTINA,1,17)
...
/*/{Protheus.doc} OZ06M03 - Cadastro Contabil Argo - Uso Protheus - OZMinerals

	Função responsável Cadastro Contabil Argo - Uso Protheus - OZMinerals
...
/*/ 
User Function OZ06M03(aAutoCab,nOperacao)
...
Static Function posValid(oModel)
	...
	If nOperation = MODEL_OPERATION_INSERT
		...
		Begin Sequence
			...
			If ( (cAliasForm)->(dbSeek( PAD(cCpoFilial      ,TAMSX3("PAK_FILIAL") [1]) +; 
							  			PAD(cCpoCodigoID    ,TAMSX3("PAK_ID")     [1]) )))
...
Static Function showLogInConsole(cMensagem,lAtivaLog,cPrefixo)
	...
	Default cMensagem 	:= ""
	Default cPrefixo	:= "[OZ06M03][" + DtoC(DDATABASE) + "][" + Time() + "] "	
Return
