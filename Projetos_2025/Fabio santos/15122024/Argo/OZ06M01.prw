...
#DEFINE ROTINA_FILE				"OZ06M01.prw"
...
#Define ALIAS_FORM0 			"PAP" 
#Define MODELO					"OZ06M01"
#Define ID_MODEL				"OZ06A01"
#Define TITULO_MODEL			"Cadastro De-Para Protheus x Argo - OZMinerals" + SubStr(VERSAO_ROTINA,1,17)
...
/*/{Protheus.doc} OZ06M01 - Cadastro De-Para Protheus x Argo - OZMinerals

	Função responsável Cadastro De-Para Protheus x Argo
...
/*/ 
User Function OZ06M01(aAutoCab,nOperacao)
	...
	Else	
		...
		oFwMBrowse:AddLegend( cAliasForm+"_EMPPRO == '01'  ", "BR_VERDE   " , "Matriz" )
		oFwMBrowse:AddLegend( cAliasForm+"_EMPPRO == '02'  ", "BR_AZUL    " , "Curionopolis" )
		oFwMBrowse:AddLegend( cAliasForm+"_EMPPRO == '03'  ", "BR_AMARELO " , "Paraubebas Intertek" )
		oFwMBrowse:AddLegend( cAliasForm+"_EMPPRO == '04'  ", "BR_VERMELHO" , "Avanco Resouces Mineração" )
		oFwMBrowse:AddLegend( cAliasForm+"_EMPPRO == '05'  ", "BR_CINZA   " , "Cannaa Dos Carjas" )
		oFwMBrowse:AddLegend( cAliasForm+"_EMPPRO == '06'  ", "BR_VIOLETA " , "Agua Azul do Norte" )
		oFwMBrowse:AddLegend( cAliasForm+"_EMPPRO == '07'  ", "BR_MARROM  " , "Paraubebas Chacara" )
...
Static Function ModelDef()
	...
	Local cCpoEmpCod		:= cPrefForm+"_EMPPRO"
	Local cCpoFilCod		:= cPrefForm+"_FILPRO"
	...
	oModel:SetPrimaryKey( { cCpoFilial, cCpoEmpCod, cCpoFilCod } )
...
Static Function posValid(oModel)
	...
	Local cCpoEmpCod	:= cPrefForm+"_EMPPRO"
	Local cCpoFilCod	:= cPrefForm+"_FILPRO"
	Local cFilLogada   	:= xFilial(cAliasForm) 
	...
	If nOperation = MODEL_OPERATION_INSERT
		...
		Begin Sequence
			...
			If (cAliasForm)->(dbSeek(cFilLogada+cCpoEmpCod+cCpoFilCod))
...
Static Function showLogInConsole(cMensagem,lAtivaLog,cPrefixo)
	...
	Default cMensagem 	:= ""
	Default cPrefixo	:= "[OZ06M01][" + DtoC(DDATABASE) + "][" + Time() + "] "	
Return
