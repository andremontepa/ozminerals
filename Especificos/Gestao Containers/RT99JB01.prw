...
//==========================================================================================================
	...
	If GET_DADOS()
		...
		While ! TMP1->(EOF())
			...
			If (TcSqlExec(cUpd) < 0)
				FwLogMsg("RT99JB01", /*cTransactionId*/, "RT99JB01", FunName(), "","[RT99JB01][PROC_INT]  [" + Dtoc(DATE()) +" "+ Time()+ "]  Falha da Execução do UPDATE - SZA ...", 0, (nStart - Seconds()), {})
			Else
				FwLogMsg("RT99JB01", /*cTransactionId*/, "RT99JB01", FunName(), "","[RT99JB01][PROC_INT]  [" + Dtoc(DATE()) +" "+ Time()+ "]  Update na Tabela SZA executado com sucesso ...", 0, (nStart - Seconds()), {})
			EndIf
			...
			If (TcSqlExec(cUpd) < 0)
				FwLogMsg("RT99JB01", /*cTransactionId*/, "RT99JB01", FunName(), "","[RT99JB01][PROC_INT]  [" + Dtoc(DATE()) +" "+ Time()+ "]  Falha da Execução do UPDATE - SZ8 ...", 0, (nStart - Seconds()), {})
			Else
				FwLogMsg("RT99JB01", /*cTransactionId*/, "RT99JB01", FunName(), "","[RT99JB01][PROC_INT]  [" + Dtoc(DATE()) +" "+ Time()+ "]  Update na Tabela SZ8 executado com sucesso ...", 0, (nStart - Seconds()), {})
			EndIf
...
//==========================================================================================================
	...
	If NQTREG <= 0
		TMP1->(DBCLOSEAREA())
		FwLogMsg("RT99JB01", /*cTransactionId*/, "RT99JB01", FunName(), "","[RT99JB01][GET_DADOS]  [" + Dtoc(DATE()) +" "+ Time()+ "]  Não ha dados para Integracao com o Protheus ...", 0, (nStart - Seconds()), {})
		Return .F.
	Else
		FwLogMsg("RT99JB01", /*cTransactionId*/, "RT99JB01", FunName(), "","[RT99JB01][GET_DADOS]  [" + Dtoc(DATE()) +" "+ Time()+ "]  Dados Encontrados para integracao ...", 0, (nStart - Seconds()), {})
    EndIf
Return .T.
