...
Funcao que realiZL a pre validacao dos dados antes de aparecer a tela de inclusao ou alteracao dos dados a serem cadastrados.
@author 	Ricardo Tavares Ferreira
@since 		14/08/2018
@version 	12.1.17
@return 	Logico
...
Funcao que realiza a validação dos dados digitado antes da gravação no banco..
@author 	Ricardo Tavares Ferreira
@since 		21/03/2018
@version 	12.1.17
@return 	Logico
