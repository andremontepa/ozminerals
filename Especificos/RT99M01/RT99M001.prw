...
...
u_RT99M001("SELECT * FROM ZA0990", "ZA0_COD", "", "")
...
...
/*/
//========================================================================================================== 
	User Function RT99M001(cConsSQLM, cRetorM, cAgrupM, cOrderM)  
//==========================================================================================================
    Local aArea   		:= GetArea()
    Local nTamBtn 		:= 50
    Local oGrpPesqui	:= Nil
    Local oGrpDados		:= Nil
    Local oGrpAcoes		:= Nil
    Local oBtnConf		:= Nil
    Local oBtnLimp		:= Nil
...
//==========================================================================================================
    ...
    For nAtual := 1 To Len(aStruAux)
        ...
        aCpoAux := FWSX3Util():GetFieldStruct(cCampoAtu) 
     
        //Se coneguir posicionar no campo
        If Len(aCpoAux) > 0
            //Cabeçalho ...    Titulo        Campo        Mask                                    Tamanho                Dec                    Valid    Usado    Tip                F3    CBOX
		    Aadd(aHeadAux,{ GetSX3Cache(aCpoAux[1],"X3_TITULO"), aCpoAux[1], X3Picture(aCpoAux[1]),aCpoAux[3],aCpoAux[4],GetSX3Cache(aCpoAux[1],"X3_VALID"),GetSX3Cache(aCpoAux[1],"X3_USADO"), aCpoAux[2],"",GetSX3Cache(aCpoAux[1],"X3_CONTEXT")})
...
//==========================================================================================================  
    ...
    //Se tiver aspa simples ou porcentagem, a pesquisa não pode prosseguir
