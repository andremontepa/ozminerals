...
/*/{Protheus.doc} OZ04M29

	Rotina que Restura o back-up do lote 008840 
		...
		If lFiltrado
			...
			Else
				If ( FindFunction("estoque.Producao.Custeio.u_RetornaLoteContabilDoCusteio") )
					FWMsgRun(,{|| estoque.Producao.Custeio.u_RetornaLoteContabilDoCusteio(MV_PAR01,MV_PAR02,MV_PAR03,MV_PAR04)} ,"Restaurando o Back-up do lote Contabil (008840) do Custeio ...","Aguarde")
				EndIf
