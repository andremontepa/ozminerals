...
/*/
//--------------------------------------------------------------------
User Function UPD_ABAXF1( cEmpAmb, cFilAmb )
...
aAdd( aSX3, { ;
	...
	20																		, ; //X3_TAMANHO
	0																		, ; //X3_DECIMAL
	'Usuario Abax'															, ; //X3_TITULO
	'Usuario Abax'															, ; //X3_TITSPA
	'Usuario Abax'															, ; //X3_TITENG
	'Usuario Abax'															, ; //X3_DESCRIC
	'Usuario Abax'															, ; //X3_DESCSPA
	'Usuario Abax'															, ; //X3_DESCENG
	''																		, ; //X3_PICTURE
	''																		, ; //X3_VALID
