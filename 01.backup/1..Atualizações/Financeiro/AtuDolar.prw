...
If	Select('SX2') == 0
    ...
    FwLogMsg("AtuDolar", /*cTransactionId*/, "AtuDolar", FunName(), "", "01",'Dollar - Atualizacao de Moedas... '+Dtoc(DATE())+' - '+Time(), 0, (nStart - Seconds()), {})
	lAuto := .T.
Endif
...
if	( lAuto )
	If lAtuOk
    	FwLogMsg("AtuDolar", /*cTransactionId*/, "AtuDolar", FunName(), "", "01",'Dollar - Moedas Atualizadas. '+Dtoc(date())+' - '+Time(), 0, (nStart - Seconds()), {})
		MemoWrit(cPath+"Dolar"+DTOS(dDatabase)+".txt",cLinha)
	Else
    	FwLogMsg("AtuDolar", /*cTransactionId*/, "AtuDolar", FunName(), "", "01",'Dollar - Moedas N�o Atualizadas. '+Dtoc(date())+' - '+Time(), 0, (nStart - Seconds()), {})
	EndIf
