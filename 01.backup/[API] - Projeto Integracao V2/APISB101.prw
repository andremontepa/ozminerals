...
/*/{Protheus.doc} APISB101
Webservice Responsavel por realizar a busca dos dados de Produtos.
@type method 
...
/*/
//=============================================================================================================================
    WSRestFul Produtos Description "Busca os dados de Produtos no sistema"
//=============================================================================================================================
    ...
    WsMethod GET Description "Busca os dados de Produtos no sistema." WsSyntax "/Produtos"
End WSRestFul

/*/{Protheus.doc} GET - Produtos
...
/*/
//=============================================================================================================================
    WsMethod GET WsReceive startindex, count, Empresa, Filial, Filter, pk WsRest Produtos
//=============================================================================================================================
    ...
    oApiExc := APIExeJS():New("oRestSB1","001",RetCodUsr(),"GET",::Empresa,::Filial,{"SB1"},::pk)
