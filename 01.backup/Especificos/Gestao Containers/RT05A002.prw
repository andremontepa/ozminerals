...
//==========================================================================================================
	...
	SetKey(VK_F11,{|| Pergunte(cPerg,.T.)})
...
//==========================================================================================================
	...
	If lEditC
		If cNFSX5 <> aNfSer[3]
			cSql := " UPDATE " +RetSqlName("SX5")
			cSql += " SET X5_DESCRI = '"+cNFSX5+"',X5_DESCSPA = '"+cNFSX5+"',X5_DESCENG = '"+cNFSX5+"' "
			cSql += " WHERE " 
			cSql += " X5_FILIAL = '"+FWXFilial("SX5")+"' "
			cSql += " AND X5_TABELA = '01' "
			cSql += " AND X5_CHAVE = '"+cSerX5+"' " 
			TcSQLExec(cSql)
		EndIf
	EndIf
	Odlg:End()
