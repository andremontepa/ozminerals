...
/*/{Protheus.doc} APIZR301
Webservice Responsavel por realizar a busca dos dados de Usuarios.
@type method 
...
/*/
//=============================================================================================================================
    WSRestFul Usuarios Description "Busca os dados de Usuarios no sistema"
//=============================================================================================================================
    ...
    WsMethod GET Description "Busca os dados de Usuarios no sistema." WsSyntax "/Usuarios"
End WSRestFul

/*/{Protheus.doc} GET - Usuarios
...
/*/
//=============================================================================================================================
    WsMethod GET WsReceive startindex, count, Empresa, Filial, Filter, pk WsRest Usuarios
//=============================================================================================================================
    ...
    oApiExc := APIExeJS():New("oRestZR3","001",RetCodUsr(),"GET",::Empresa,::Filial,{"ZR3"},::pk)
