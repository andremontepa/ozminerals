...
/*/{Protheus.doc} APISAH01
Webservice Responsavel por realizar a busca dos dados de Unidade de Medida.
@type method 
...
/*/
//=============================================================================================================================
    WSRestFul UnidadeMedida Description "Busca os dados de Unidade de Medida no sistema"
//=============================================================================================================================
    ...
    WsMethod GET Description "Busca os dados de Unidade de Medida no sistema." WsSyntax "/UnidadeMedida"
End WSRestFul

/*/{Protheus.doc} GET - UnidadeMedida
...
/*/
//=============================================================================================================================
    WsMethod GET WsReceive startindex, count, Empresa, Filial, Filter, pk WsRest UnidadeMedida
//=============================================================================================================================
    ...
    oApiExc := APIExeJS():New("oRestSAH","001",RetCodUsr(),"GET",::Empresa,::Filial,{"SAH"},::pk)
