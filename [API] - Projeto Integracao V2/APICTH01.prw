...
/*/{Protheus.doc} APICTH01
Webservice Responsavel por realizar a busca dos dados de Classe Valor.
@type method 
...
/*/
//=============================================================================================================================
    WSRestFul ClasseValor Description "Busca os dados de Classe Valor no sistema"
//=============================================================================================================================
    ...
    WsMethod GET Description "Busca os dados de Classe Valor no sistema." WsSyntax "/ClasseValor"
End WSRestFul

/*/{Protheus.doc} GET - ClasseValor
...
/*/
//=============================================================================================================================
    WsMethod GET WsReceive startindex, count, Empresa, Filial, Filter, pk WsRest ClasseValor
//=============================================================================================================================
    ...
    oApiExc := APIExeJS():New("oRestCTH","001",RetCodUsr(),"GET",::Empresa,::Filial,{"CTH"},::pk)
