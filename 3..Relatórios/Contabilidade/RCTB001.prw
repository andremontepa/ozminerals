...
Else
	...
	{ "AMOUNT"	    , "N", aTamVal[1]+2	, nDecimais },;  	// Movimento do Periodo Rateado na CQ2        - Toni Aguiar - TOTVS STARSOFT em 01/02/2022
	{ "NATCTA"      , "C", 02           , 0 }}              // NATCTA -campo de natureza da conta para relatorio CTBR047
...
If Empty( aCampos )
	FwLogMsg("RCTB001", /*cTransactionId*/, "RCTB001", FunName(), "", "01","Erro na criacao da tabela temporaria", 0, (nStart - Seconds()), {})	
    Return .F.
EndIf
	...
	If TcSrvType() != "AS/400" .and. lTemQuery .and. Select("TRBTMP") > 0 	/// E O ALIAS TRBTMP ESTIVER ABERTO (INDICANDO QUE A QUERY FOI EXECUTADA)
		...
		While TRBTMP->(!Eof())			/// REPLICA OS DADOS DA QUERY (TRBTMP) PARA P/ O TEMPORARIO EM DISCO
			...
			If &("TRBTMP->("+cFILUSU+")")
                ...
                // Toni Aguiar - TOTVS STARSOFR em 01/02/2022
                If Len(aRat)<>0	
