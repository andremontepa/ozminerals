...
/*/{Protheus.doc} APICTD01
Webservice Responsavel por realizar a busca dos dados de Item Contabil.
@type method 
...
/*/
//=============================================================================================================================
    WSRestFul ItemContabil Description "Busca os dados de Item Contabil no sistema"
//=============================================================================================================================
    ...
    WsMethod GET Description "Busca os dados de Item Contabil no sistema." WsSyntax "/ItemContabil"
End WSRestFul

/*/{Protheus.doc} GET - ItemContabil
...
/*/
//=============================================================================================================================
    WsMethod GET WsReceive startindex, count, Empresa, Filial, Filter, pk WsRest ItemContabil
//=============================================================================================================================
    ...
    oApiExc := APIExeJS():New("oRestCTD","001",RetCodUsr(),"GET",::Empresa,::Filial,{"CTD"},::pk)
