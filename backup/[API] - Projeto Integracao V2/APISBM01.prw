...
/*/{Protheus.doc} APISBM01
Webservice Responsavel por realizar a busca dos dados de Grupo de Produto.
@type method 
...
/*/
//=============================================================================================================================
    WSRestFul GrupoProd Description "Busca os dados de Grupo de Produto no sistema"
//=============================================================================================================================
    ...
    WsMethod GET Description "Busca os dados de Grupo de Produto no sistema." WsSyntax "/GrupoProd"
End WSRestFul

/*/{Protheus.doc} GET - GrupoProd
...
/*/
//=============================================================================================================================
    WsMethod GET WsReceive startindex, count, Empresa, Filial, Filter, pk WsRest GrupoProd
//=============================================================================================================================
    ...
    oApiExc := APIExeJS():New("oRestSBM","001",RetCodUsr(),"GET",::Empresa,::Filial,{"SBM"},::pk)
