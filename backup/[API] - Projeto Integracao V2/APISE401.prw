...
/*/{Protheus.doc} APISE401
Webservice Responsavel por realizar a busca dos dados de Condição de Pagamento.
@type method 
...
/*/
//=============================================================================================================================
    WSRestFul CondPagto Description "Busca os dados de Condição de Pagamento no sistema"
//=============================================================================================================================
    ...
    WsMethod GET Description "Busca os dados de Condição de Pagamento no sistema." WsSyntax "/CondPagto"
End WSRestFul

/*/{Protheus.doc} GET - CondPagto
...
/*/
//=============================================================================================================================
    WsMethod GET WsReceive startindex, count, Empresa, Filial, Filter, pk WsRest CondPagto
//=============================================================================================================================
    ...
    oApiExc := APIExeJS():New("oRestSE4","001",RetCodUsr(),"GET",::Empresa,::Filial,{"SE4"},::pk)
