...
//===============================================================================================================
	...
	If TCSQLExec(cDelete) < 0
		FwLogMsg("AVBUtil", /*cTransactionId*/, "AVBUtil", FunName(), "","Erro ao Deletar os Dados da Tabela SCR " + TCSQLError(), 0, (nStart - Seconds()), {})
    EndIf 
...
//
	...
	If TcSqlExec(cUpd) < 0
		FwLogMsg("AVBUtil", /*cTransactionId*/, "AVBUtil", FunName(), "","[AVBUtil] [TrocaGrupoAprovacao]  [" + Dtoc(DATE()) +" "+ Time()+ "]  Falha da Execução do UPDATE - Tabela ("+cTabela+") ...", 0, (nStart - Seconds()), {})
	Else
		FwLogMsg("AVBUtil", /*cTransactionId*/, "AVBUtil", FunName(), "","[AVBUtil] [TrocaGrupoAprovacao]  [" + Dtoc(DATE()) +" "+ Time()+ "]  Update na Tabela "+cTabela+" executado com sucesso ...", 0, (nStart - Seconds()), {})
	EndIf
Return Nil 
