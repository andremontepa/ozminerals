...
//==========================================================================================================
	...
	If NQTREG <= 0
		TMP1->(DBCLOSEAREA())
		FwLogMsg("RT99JB02", /*cTransactionId*/, "RT99JB02", FunName(), "","[RT99JB02][GET_DADOS]  [" + Dtoc(DATE()) +" "+ Time()+ "]  Não ha Ordens de Carregamento Pendentes de Encerramento ...", 0, (nStart - Seconds()), {})
		Return .F.
	Else
		FwLogMsg("RT99JB02", /*cTransactionId*/, "RT99JB02", FunName(), "","[RT99JB02][GET_DADOS]  [" + Dtoc(DATE()) +" "+ Time()+ "] Ha Ordens de Carregamento Pendentes de Encerramento ...", 0, (nStart - Seconds()), {})
    EndIf
