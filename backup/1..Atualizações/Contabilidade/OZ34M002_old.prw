...
//=============================================================================================================================
    ...
    If TCSQLExec(cDelete) < 0
        Conout("Erro ao Deletar os Dados da Tabela CT2 " + TCSQLError())
    EndIf 
Return Nil 
...
//=============================================================================================================================
    ...
    Local lDebito       := .F.
    Local lCredit       := .F.
    Local cContCTA1     := SuperGetMV("OZ_CONTCTA",.F.,"860190997") 
    Local cContCTA2     := SuperGetMV("OZ_CONTCTA",.F.,"850190997") 
    Local lExistGRP     := .F.
    Local aExistCTA     := {}
    ...
    If GetDadosGerais()
        While .not. (cAliasALL)->(Eof())
            ...
            aExistCTA := lExistCTA(xFil,xData,xLote,xSbLote,xDoc)
            If .not. aExistCTA[1]
                ...
                nLin       := StrZero(GetLinhaAtu(xFil,xData,xLote,xSbLote,xDoc) + 1,TamSX3("CT2_LINHA")[1])
                ...
                If nValFim > 0
                    RecLock("CT2",.T.)
                        ...
                        CT2->CT2_LINHA  := nLin
                        CT2->CT2_MOEDLC := "02"
                        CT2->CT2_HIST   := "CONVERSAO CTA - " + aExistCTA[2]
                        CT2->CT2_EMPORI := "01"
                        CT2->CT2_FILORI := xFil
                        CT2->CT2_TPSALD := "1"
                        CT2->CT2_MANUAL := "1"
                        CT2->CT2_ORIGEM := "OZ34M002 - CONVERSAO CTA - USUARIO: "+Iif(Empty(RetCodUsr()),"JOB",AllTrim(Upper(UsrRetName(RetCodUsr()))))
...
/*/
//=============================================================================================================================
    Static Function VerificaGrupo(xFil,xData,xLote,xSbLote,xDoc)
//=============================================================================================================================
...
/*/
//=============================================================================================================================
    Static Function GetDadosCredit(xFil,xData,xLote,xSbLote,xDoc)
//=============================================================================================================================
...
/*/
//=============================================================================================================================
    Static Function GetDadosDebito(xFil,xData,xLote,xSbLote,xDoc)
//=============================================================================================================================
