...
±±ºDesc.     ³ PEDIDO DE COMPRAS (Emissao em formato Grafico Retrato)     º±±
...
Private	oBrush		:= TBrush():New(,4),;
		...
		While 	TRA->( ! Eof() )
				...
				If	( lPrintDesTab )
					...
					oPrint:Say(nLinha+10,0340,OemToAnsi('Descrição'),oFont12n)
					oPrint:Say(nLinha+10,1380,OemToAnsi('Un'),oFont12n)
...
Static Function xCabec()
		...
		oPrint:Box(0010,0050,3100,2350)    
		...
		oPrint:Say(225,1300,AllTrim('www.avanco.com.br'),oFont11)
