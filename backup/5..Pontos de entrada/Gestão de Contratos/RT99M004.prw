...
//==========================================================================================================  
	...
	For nX := 1 To Len(aCampos)
		cTabcus := SUBSTR(Alltrim(aCampos[nX][1]),1,At("_",aCampos[nX][1],1)-1)  
	    cCont := Iif(len(cTabcus)=2,"S"+cTabcus,cTabcus)+"->" + Alltrim(aCampos[nX][1])
...
@version 12.1.33
@history 25/04/2022, Ricardo Tavares Ferreira, Construção Inicial
@return character, Retorna o codigo da amarração encontrada.
/*/
//==========================================================================================================
