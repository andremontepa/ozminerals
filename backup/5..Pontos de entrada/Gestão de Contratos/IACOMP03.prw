...
user function IACOMP03(cOldEmp, cNewEmp, cChvSc7)
	...
	FwLogMsg("IACOMP03", /*cTransactionId*/, "IACOMP03", FunName(), "","Antes RPCSETENV", 0, (nStart - Seconds()), {})

	RpcSetType(3)
	RpcSetEnv(cNewEmp,Left(cChvSc7,02),,,"COM")
	FwLogMsg("IACOMP03", /*cTransactionId*/, "IACOMP03", FunName(), "","Empresa " + cEmpAnt, 0, (nStart - Seconds()), {})
	FwLogMsg("IACOMP03", /*cTransactionId*/, "IACOMP03", FunName(), "","Chave " + cChvSc7, 0, (nStart - Seconds()), {})
			
	dbSelectArea("SC7")
	SC7->(dbSetOrder(01))
	If SC7->(dbSeek(cChvSc7))
		FwLogMsg("IACOMP03", /*cTransactionId*/, "IACOMP03", FunName(), "","Achou Pedido", 0, (nStart - Seconds()), {})
		...
		if (nStatus < 0)
			FwLogMsg("IACOMP03", /*cTransactionId*/, "IACOMP03", FunName(), "","TCSQLError() " + TCSQLError(), 0, (nStart - Seconds()), {})
		endif
		...
		If !lMsErroAuto
			FwLogMsg("IACOMP03", /*cTransactionId*/, "IACOMP03", FunName(), "","Alterado PC: " + cChvSc7, 0, (nStart - Seconds()), {})
		Else
			FwLogMsg("IACOMP03", /*cTransactionId*/, "IACOMP03", FunName(), "","Erro na alteracao!", 0, (nStart - Seconds()), {})

			cError := MostraErro("/dirdoc", "error.log") // ARMAZENA A MENSAGEM DE ERRO
			FwLogMsg("IACOMP03", /*cTransactionId*/, "IACOMP03", FunName(), "",PadC("Automatic routine ended with error", 80), 0, (nStart - Seconds()), {})
			FwLogMsg("IACOMP03", /*cTransactionId*/, "IACOMP03", FunName(), "","Error: "+ cError, 0, (nStart - Seconds()), {})
