...
//==========================================================================================================
	...
	For nX := 1 To Len(aEmpresas)
		...
		Conout("[26]  [RT99JB03] [" + Dtoc(DATE()) +" "+ Time()+ "] Inicio da Execucao do JOB RT99JB03...")
		PROC_INT()
		Conout("[28]  [RT99JB03] [" + Dtoc(DATE()) +" "+ Time()+ "] Fim da Execucao do JOB RT99JB03...")
...
//==========================================================================================================
	...
	If nQtdReg <= 0
		TMP1->(DbCloseArea())
		Conout("[106] [RT99JB03] [GET_DADOS] [" +Dtoc(DATE())+" "+Time()+ "]  Não ha dados para serem processados EMPRESA ["+cEmpAnt+"]...")
		Return .F.
    EndIf
Return .T.
