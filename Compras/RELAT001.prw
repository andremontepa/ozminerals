...
±±ºPrograma  ³ RELAT001 ºAutor ³Lucas Costa       º Data ³    12/05/2021  º±±
±±ÌÍÍÍÍÍÍÍÍÍÍØÍÍÍÍÍÍÍÍÍÍÊÍÍÍÍÍÍÏÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÊÍÍÍÍÍÍÏÍÍÍÍÍÍÍÍÍÍÍÍÍ¹±±
±±ºDesc.     ³ Relatório de Pedidos de Compras em Alçada                  º±±
...
User Function RELAT001()
	Local oReport := nil
	Local cPerg:= PadR("PC000001", Len(SX1->X1_GRUPO))
...
Static Function RptDef(cNome)
	...
	oReport := TReport():New(cNome,"Pedidos em Alçada",cNome,{|oReport| ReportPrint(oReport)},"Pedidos Bloqueadas")
	oReport:SetPortrait()    
