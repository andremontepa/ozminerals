...
User Function  MT120LOK()
	...
	//COMENTADO POR LEONARDO MEDEIROS. PARA FUNCIONAMENTO DEVERÁ SER TRATADA PRIEMIRAMENTE A INTEGRAÇÃO DO BASE B PARA QUE O WEBSERVICE
	//BUSQUE A APROPRIAÇÃO INFORMADA NA SC E NÃO NO CADASTRO DO PRODUTO. TRATAR TAMBÉM NO ENCERRAMENTO DA MEDIÇÃO APRA QUE BUSQUE
	//A APROPRIAÇÃO INDICADA NA MEDIÇÃO
