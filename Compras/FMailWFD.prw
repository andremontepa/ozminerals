...
Conout("WF ENVIA E-MAIL DIARIO Data: "+dtoc(ddatabase)+ "Hora: "+time()+" WorkFlow Iniciado ")
...
Conout("( WF ENVIA E-MAIL DIARIO Data: "+dtoc(ddatabase)+ "Hora: "+time()+" E-mail Enviado com Sucesso ")
...
DBUSEAREA(.t.,,carq,cAliasTemp)

DbSelectArea(cAliasTemp)
DbCreateIndex(cAliasTemp+cArq,cIndTemp)
DbSetIndex(cAliasTemp+cArq)
